...
| コード | 商品名 | 単位 | 単価 |
|---|---|---|---|
| VPC-BL2-14 | ノートPC 14型、メモリ16GB | 台 | 168,000 |
| VPC-BL2-15 | ノートPC 15型、メモリ32GB | 台 | 218,000 |
| ACC-DOCK01 | USB-Cドッキングステーション | 台 | 18,000 |
| ACC-MOUSE02 | ワイヤレスマウス(黒) | 個 | 4,000 |
| ACC-KB01 | ワイヤレスキーボード(日本語) | 個 | 6,800 |
| MON-24W | 液晶モニタ 24型 ワイド | 台 | 22,800 |
| ACC-USB64 | USBメモリ 64GB | 個 | 1,200 |
| NW-RT01 | 無線LANルーター | 台 | 9,800 |
| SFT-OFF01 | オフィスソフト ライセンス | 本 | 38,000 |
| SVC-SHIP | 配送料 | 式 | 1,500 |
...
5. 明細1行目：`#item-code-1` に `VPC-BL2-14`、`#qty-1` に数量を入力（以降の行も同様）
6. `#btn-submit` をクリック
